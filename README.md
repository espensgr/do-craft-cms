...
These steps will get this sample Craft Cms application running for you using DigitalOcean App Platform.
...
[![Deploy to DigitalOcean](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/apps/new?repo=https://github.com/espensgr/do-craft-cms/tree/master)
...
After forking the repo, you should now be viewing this README in your own github org (e.g. `https://github.com/<your-org>/do-craft-cms`). To deploy the new repo, visit https://cloud.digitalocean.com/apps and click "Create App" or "Launch Your App". Then, select the repository you created and be sure to select the `master` branch.
